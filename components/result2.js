...
const Result2 = ({ navigation }) => {
    ...
    const moveUp = () => {
        // Will change positionAnim value to 10 in 5 seconds
    ...
    return (
        <View style={styles.main}>
            <View style={styles.filterButton}>
                <Button
                    title="Filter"
                    onPress={() => navigation.navigate('Filter')}></Button>
            </View>
            <Animated.View style={[styles.searchBox, {
                marginTop: positionAnim
            }]}>
                <Text style={styles.searchPlaceHolder}>Normal Animation</Text>
            </Animated.View>
            <ScrollView>
                {data.map((item, index) => (
